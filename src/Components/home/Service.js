                ...
                <div className="col-md-4">
                    <div className="card mx-auto mb-5 pt-3 bg-light" style={{ "width": " 18rem" }}>
                        ...
                        <div className="card-body">
                            <h5 className="card-title text-center">Aplicaciones Web</h5>
                            <p className="card-text text-center text-color">Desarrollamos aplicaciones web personalizadas y únicas para satisfacer tus necesidades, de principio a fin. Contáctanos para llevar tu proyecto al siguiente nivel..</p>
                        </div>
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="card mx-auto mb-5 pt-3 bg-light" style={{ "width": " 18rem" }}>
                        ...
                        <div className="card-body">
                            <h5 className="card-title text-center">Aplicaciones móviles</h5>
